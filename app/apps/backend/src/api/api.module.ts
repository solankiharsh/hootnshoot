...
import { ComplianceDisabledMiddleware } from '@gitroom/nestjs-libraries/compliance/compliance.disabled.middleware';
...
import { CaptionController } from '@gitroom/backend/api/routes/caption.controller';
import { CaptionModule } from '@gitroom/nestjs-libraries/caption/caption.module';
import { ImageController } from '@gitroom/backend/api/routes/image.controller';
import { ImageModule } from '@gitroom/nestjs-libraries/image/image.module';
import { TemplatesController } from '@gitroom/backend/api/routes/templates.controller';
...
import { ComplianceModule } from '@gitroom/nestjs-libraries/compliance/compliance.module';
...
@Module({
  imports: [UploadModule, CaptionModule, ImageModule, TemplateDecomposeModule, ComplianceModule],
  controllers: [
    ...publicControllers,
...
export class ApiModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer
      .apply(ComplianceDisabledMiddleware)
      .forRoutes('compliance', 'public/content-cop/callback');
