          ...
          <div>
            ...
            {!generateContent && (
              <>
                ...
                <textarea
                  className={clsx(
                    '!min-h-40 !max-h-80 p-2 overflow-x-hidden scrollbar scrollbar-thumb-[#612AD5] bg-customColor2 outline-none mb-[16px] border-fifth border rounded-[4px] w-full resize-y'
                  )}
                  value={content}
                  onChange={(e) => {
