        ...
        <div className="absolute left-0 w-full h-full pb-[20px]">
          <CopilotChat
            ...
            labels={{
              ...
              initial: t('agent_welcome_message', `Hello, I am your Hootnshoot agent 🙌🏻.
...
function userMessageContentAsString(
  content: UserMessageProps['message'] extends { content: infer C } ? C : never
): string {
...
const Message: FC<UserMessageProps> = (props) => {
  const convertContentToImagesAndVideo = useMemo(() => {
    return userMessageContentAsString(props.message?.content)
