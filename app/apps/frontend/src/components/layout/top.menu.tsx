...
export const useMenuItem = () => {
  ...
  const firstMenu = [
    /* Hidden — /create no longer needed in nav (route may still exist)
    {
      name: t('createPost', 'Create Post'),
    ...
    */
    ...
    /* Hidden for hootnshoot - not needed yet
    {
      name: 'Agent',
      icon: (
        <svg
...
export const TopMenu: FC = () => {
  ...
  return (
    <>
      <div className="flex flex-1 flex-col items-center minCustom:gap-[16px] blurMe">
        {
          // @ts-ignore
          user?.orgId &&
            // @ts-ignore
      ...
      <div className="flex flex-col items-center minCustom:gap-[16px] blurMe">
        {secondMenu
          .filter((f) => {
            if (f.hide) {
              return false;
