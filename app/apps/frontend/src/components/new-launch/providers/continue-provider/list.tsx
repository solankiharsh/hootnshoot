...
import { FacebookLateContinue } from '@gitroom/frontend/components/new-launch/providers/continue-provider/facebook-late/facebook-late.continue';
...
export const continueProviderList = {
  ...
  'facebook-late': FacebookLateContinue,
};
