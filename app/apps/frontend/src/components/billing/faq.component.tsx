  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_hootnshoot',
              'Am I going to be charged by Hootnshoot?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_hootnshoot_will_hold',
              'To confirm credit card information Hootnshoot will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_hootnshoot',
        'Can I trust Hootnshoot?'
      ),
      description: t(
        'faq_hootnshoot_is_proudly_open_source',
        'Hootnshoot is proudly open source. You can review the full codebase in this repository.'
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_hootnshoot_allows_you_to_schedule_posts',
        `Hootnshoot allows you to schedule your posts between different channels.
