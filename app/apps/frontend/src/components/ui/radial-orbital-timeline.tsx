...
import { ShadcnButton } from '@gitroom/frontend/components/ui/shadcn-button';
import { Card, CardContent, CardHeader, CardTitle } from '@gitroom/frontend/components/ui/card';
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Center orb */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-[#FF444F] via-[#c0392b] to-[#612bd3] animate-pulse flex items-center justify-center z-10">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle, rgba(255,68,79,0.25) 0%, rgba(255,68,79,0) 70%)',
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-[#FF444F] to-[#612bd3]"
