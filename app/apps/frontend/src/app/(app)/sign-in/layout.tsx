...
const ReturnUrlComponent = loadDynamic(
  () => import('../auth/return.url.component')
);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            className="[&_h1]:text-[#1A1A1A] [&_h2]:text-[#1A1A1A] [&_p]:text-[#6B6762] [&_label]:text-[#6B6762]"
          >
            {children}
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: 12, color: '#9B9490', marginTop: 32, lineHeight: 1.6 }}>
            ...
            <a href="https://hootnshoot.app/terms" style={{ color: '#6B6762', textDecoration: 'underline' }}>Terms</a>
            ,{' '}
            <a href="https://hootnshoot.app/privacy" style={{ color: '#6B6762', textDecoration: 'underline' }}>Privacy</a>
          </p>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '14%', left: '10%', maxWidth: 400 }}>
          <h2 style={{ fontFamily: 'Georgia, "Times New Roman", serif', fontSize: 48, fontWeight: 400, lineHeight: 1.2, color: '#1A1A1A', marginBottom: 14 }}>
            Schedule smarter.<br />Post bolder.
          </h2>
          <p style={{ fontSize: 15, color: '#6B6762', lineHeight: 1.5 }}>
