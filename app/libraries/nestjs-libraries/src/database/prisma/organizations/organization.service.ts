...
export class OrganizationService {
  ...
  createPersonalOrg(userId: string, displayName: string) {
    return this._organizationRepository.createPersonalOrg(userId, displayName);
  }

  createNamedOrg(userId: string, companyName: string) {
    return this._organizationRepository.createNamedOrg(userId, companyName);
  }
